...
/// A platform-agnostic card representing a beacon which can be in a card state,
...
/// This is an example of a custom widget that an app developer might create for
/// use on both iOS and Android as part of their brand's unique design.
class HeroAnimatingBeaconCard extends StatelessWidget {
  const HeroAnimatingBeaconCard({
        ...
        return PressableCard(
          ...
          child: SizedBox(
            ...
            child: Stack(
              ...
              children: [
                // The beacon title banner slides off in the hero animation.
                Positioned(
...
/// A loading beacon tile's silhouette.
///
/// This is an example of a custom widget that an app developer might create for
/// use on both iOS and Android as part of their brand's unique design.
class BeaconPlaceholderTile extends StatelessWidget {
  const BeaconPlaceholderTile({super.key});
