...
class _PlatformAdaptingHomePageState extends State<PlatformAdaptingHomePage> {
  ...
  // all 4 possible tabs. This drawer is injected into the beacons tab which is
      ...
      tabBar: CupertinoTabBar(
        items: const [
          BottomNavigationBarItem(
            label: BeaconsTab.title,
            icon: BeaconsTab.iosIcon,
          ),
          BottomNavigationBarItem(
            label: SaleTab.title,
        ...
        switch (index) {
          case 0:
            return CupertinoTabView(
              defaultTitle: BeaconsTab.title,
              builder: (context) => BeaconsTab(key: beaconsTabKey),
            );
          case 1:
            return CupertinoTabView(
    ...
    return Drawer(
      child: Column(
        ...
        children: [
          ...
          ListTile(
            leading: BeaconsTab.androidIcon,
            title: const Text(BeaconsTab.title),
            onTap: () {
